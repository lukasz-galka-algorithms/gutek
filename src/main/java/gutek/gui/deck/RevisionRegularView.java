...
/**
 * A view that facilitates the regular revision of cards from a deck.
 *
 * This view handles the logic for presenting the front of a card, allowing the user to reveal the translation
 * (back side), and providing revision options based on the deck's revision algorithm.
 */
@Component
public class RevisionRegularView extends AppView {
    ...
    /** Button for revealing the translation of the current card. */
    ...
    /**
     * Constructs a new RevisionRegularView to facilitate the regular revision of cards.
     *
     ...
     */
    public RevisionRegularView(MainFrame frame, TranslationService translationService, CardService cardService,
        ...
        showButton.addActionListener(e -> showTranslation());
        ...
        for (int i = 0; i < components.length; i++) {
            ...
            if (comp instanceof JButton) {
                ...
                button.addActionListener(e -> {
                    buttonsPanel.removeAll();
                    cardRevisionService.reviseRegular(currentCard, pressedButtonIndex);
