...
public class ReverseRevisionChart extends StatisticsChart {
    ...
    public JFreeChart getChart(int range, DeckBase deck) {
        ...
        for (int i = 0; i < range; i++) {
            dataset.addValue(reverseRevisionCounts[range - i - 1], rowKey, String.valueOf(-(range - i - 1)));
        }
    ...
    public String getChartTitle() {
        return translationService.getTranslation("deck_view.statistics.reverse_revision_title");
    }
}
