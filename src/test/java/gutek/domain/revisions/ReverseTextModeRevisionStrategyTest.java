...
class ReverseTextModeRevisionStrategyTest {

    private ReverseTextModeRevisionStrategy<CardBase> revisionStrategy;
    ...
    void setUp() {
        ...
        revisionStrategy = new ReverseTextModeRevisionStrategy<>(mockPaneFunction, mockPredicate);
    ...
    void testGetRevisionStrategyTranslationKey() {
        // Arrange
        String expectedKey = "reverse_text_mode";
    ...
    void testGetRevisionStrategyColor() {
        // Arrange
        Color expectedColor = Color.OLIVE;
    ...
    void testGetRevisionStrategyScene() {
        // Arrange
        MainStageScenes expectedScene = MainStageScenes.REVISION_REVERSE_SCENE;
    ...
    void testGetRevisionStrategyCardsCount() {
        // Arrange
        int expectedCount = 5;
        when(mockDeckService.getReverseRevisionCardsCount(mockDeckBase)).thenReturn(expectedCount);
    ...
    void testGetNextRevisionDate() {
        ...
        when(mockCard.getNextReverseRevisionDate()).thenReturn(expectedDate);
